...
(function () {
  var IC = {
    ...
    '❤': '<path d="M20.8 8.6c0-2.5-2-4.3-4.4-4.3-1.6 0-3 .9-3.7 2.2-.7-1.3-2.1-2.2-3.7-2.2C6.6 4.3 4.6 6.1 4.6 8.6c0 4 6.1 8 7.4 8.9 1.3-.9 7.4-4.9 7.4-8.9z"/>',
    '🤍': '<path d="M20.8 8.6c0-2.5-2-4.3-4.4-4.3-1.6 0-3 .9-3.7 2.2-.7-1.3-2.1-2.2-3.7-2.2C6.6 4.3 4.6 6.1 4.6 8.6c0 4 6.1 8 7.4 8.9 1.3-.9 7.4-4.9 7.4-8.9z"/>',
    '⚖': '<path d="M12 3v18M8 21h8M5.5 7h13M5.5 7l-3 6a3 3 0 0 0 6 0l-3-6zM18.5 7l-3 6a3 3 0 0 0 6 0l-3-6z"/><circle cx="12" cy="4.5" r="1.4"/>',
    '💰': '<path d="M9 3h6l-1.4 2.8H10.4L9 3z"/><path d="M12 5.8c-3.6 2.8-5.4 5.6-5.4 8.4a5.4 5.4 0 0 0 10.8 0c0-2.8-1.8-5.6-5.4-8.4z"/><path d="M12 10.5v5M10.7 11.7h2.4a1.1 1.1 0 0 1 0 2.2h-2.4"/>',
    '➕': '<path d="M12 5v14M5 12h14"/>',
    '📅': '<rect x="3" y="4.5" width="18" height="17" rx="2.5"/><path d="M3 9.5h18M8 2.5v4M16 2.5v4"/>',
    '🔁': '<path d="M17 2l4 4-4 4M3 11V9a4 4 0 0 1 4-4h14M7 22l-4-4 4-4M21 13v2a4 4 0 0 1-4 4H3"/>',
    '📈': '<path d="M3 3v18h18"/><path d="M7 14l4-4 3 3 5-6M19 7h-3M19 7v3"/>',
    '📉': '<path d="M3 3v18h18"/><path d="M7 10l4 4 3-3 5 6M19 17h-3M19 17v-3"/>',
    '📊': '<path d="M3 3v18h18"/><path d="M8 17v-5M13 17V8M18 17v-8"/>',
    '🛠': '<path d="M14.7 6.3a4 4 0 0 0 5.3 5.3l-8.7 8.7-5.3-5.3 8.7-8.7z"/><path d="M3 21l3.5-1 2.5-2.5-2-2L4.5 18 3 21z"/>',
    '📍': '<path d="M12 21s7-6 7-11a7 7 0 0 0-14 0c0 5 7 11 7 11z"/><circle cx="12" cy="10" r="2.5"/>',
    '📋': '<rect x="5" y="4" width="14" height="18" rx="2"/><path d="M9 4a3 3 0 0 1 6 0v1H9zM8.5 11h7M8.5 15h5"/>',
    '🏷': '<path d="M20.6 13.4l-7.2 7.2a2 2 0 0 1-2.8 0L3 13V4h9l8.6 8.6a2 2 0 0 1 0 .8z"/><circle cx="7.5" cy="8.5" r="1.2"/>',
    '🔗': '<path d="M10 13a5 5 0 0 0 7 0l2-2a5 5 0 0 0-7-7l-1 1M14 11a5 5 0 0 0-7 0l-2 2a5 5 0 0 0 7 7l1-1"/>',
    '💱': '<path d="M4 8h13l-3.5-3.5M20 16H7l3.5 3.5"/>',
    '🔥': '<path d="M12 2c1.2 3 4.2 4.2 4.2 8.2a4.2 4.2 0 0 1-8.4 0c0-1.2.4-2.2 1-3 .2 1.2 1 1.8 1.6 2 .2-2.6-.4-5.4 1.6-7.2z"/>',
    '💻': '<rect x="3" y="5" width="18" height="12" rx="2"/><path d="M2 20.5h20"/>',
    '📦': '<path d="M21 8l-9-5-9 5 9 5 9-5z"/><path d="M3 8v8l9 5 9-5V8M12 13v8"/>',
    '📷': '<rect x="3" y="7" width="18" height="13" rx="2"/><circle cx="12" cy="13.5" r="3.4"/><path d="M8.5 7l1.4-2.6h4.2L15.5 7"/>',
    '🖼': '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9" r="1.5"/><path d="M20.5 16l-5-5-8 8"/>',
    '⚡': '<path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z"/>',
    '⬇': '<path d="M12 4v14M6 12l6 6 6-6"/>',
    '💸': '<rect x="2.5" y="6" width="19" height="12" rx="2"/><circle cx="12" cy="12" r="2.6"/><path d="M6 9.5h.01M18 14.5h.01"/>',
    ...
    '🚀': '<path d="M5 15c-1.5 1.5-2 5-2 5s3.5-.5 5-2M9 11a10 10 0 0 1 8-6c2 0 2 0 2 2a10 10 0 0 1-6 8l-2 2-4-4 2-2z"/><circle cx="14.5" cy="9.5" r="1.3"/>',
    '🧠': '<path d="M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5.8V15a3 3 0 0 0 4 2.8V19a2 2 0 0 0 4 0V5a2 2 0 0 0-4 0M15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5.8V15a3 3 0 0 1-4 2.8"/>',
